...
$related  = citynet_get_related_posts($post_id);

if ($related && $related->have_posts()):
?>
<aside class="sidebar-related" role="complementary">
    <header class="sidebar-blog-title d-flex align-items-center justify-content-center">
        <p class="fw-bold my-1 d-flex align-items-center mt-3 mx-1"><?php echo esc_html__('Related Posts', 'citynet'); ?></p>
    </header>
