    ...
    <div class="row g-4">
        <?php foreach ( $posts_list as $post ) : setup_postdata( $post ); ?>
            <div class="col-12 col-md-4 col-lg-3">
                <a href="<?php echo esc_url( get_permalink() ); ?>" class="thumb-fixed rounded-3 d-block  position-relative thumb-fixed-265-248 overflow-hidden">
                    ...
                    <?php the_post_thumbnail(
                      ...
                      <div class="p-3 position-absolute text-center start-0 w-100 bottom-0">
                        
                        <span class="post-title fs-6 lh-lg d-block py-2 rounded-3  bg-white bg-opacity-100 link-body-emphasis" itemprop="headline">
                            <?php the_title(); ?>
                        </span>
                      </div>
                </a>
